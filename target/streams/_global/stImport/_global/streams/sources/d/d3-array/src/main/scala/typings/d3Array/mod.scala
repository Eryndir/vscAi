...
object mod {
  ...
  object Matrix {
    ...
    inline def apply(data: ArrayLike[Double], width: Double): Matrix = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Matrix] (val x: Self) extends AnyVal {
      ...
      inline def setData(value: ArrayLike[Double]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    TKeys extends [infer TFirst, ...infer TRest] ? std.Array<[TFirst, d3-array.d3-array.NestedArray<TObject, TReduce, TRest>]> : TReduce
    }}}
    */
  type NestedArray[TObject, TReduce, TKeys /* <: js.Array[Any] */] = TReduce
  
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    * See https://www.typescriptlang.org/docs/handbook/2/conditional-types.html for an intro.
    * This RHS of the type alias is guess work. You should cast if it's not correct in your case.
    * TS definition: {{{
    TKeys extends [infer TFirst, ...infer TRest] ? d3-array.d3-array.InternMap<TFirst, d3-array.d3-array.NestedInternMap<TObject, TReduce, TRest>> : TReduce
    }}}
    */
  type NestedInternMap[TObject, TReduce, TKeys /* <: js.Array[Any] */] = TReduce
