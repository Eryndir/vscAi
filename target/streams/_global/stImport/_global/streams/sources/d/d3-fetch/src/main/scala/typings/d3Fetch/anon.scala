...
object anon {
  ...
  trait PartialHTMLImageElement extends StObject {
    ...
    var ariaDescription: js.UndefOr[String | Null] = js.undefined
    ...
    var fetchPriority: js.UndefOr[String] = js.undefined
    ...
    var hidePopover: js.UndefOr[js.Function0[Unit]] = js.undefined
    ...
    var onbeforetoggle: js.UndefOr[(js.ThisFunction1[/* this */ this.type, /* ev */ Event, Any]) | Null] = js.undefined
    ...
    var onscrollend: js.UndefOr[(js.ThisFunction1[/* this */ this.type, /* ev */ Event, Any]) | Null] = js.undefined
    ...
    var popover: js.UndefOr[String | Null] = js.undefined
    ...
    var showPopover: js.UndefOr[js.Function0[Unit]] = js.undefined
    ...
    var togglePopover: js.UndefOr[js.Function0[Boolean]] = js.undefined
  ...
  object PartialHTMLImageElement {
    ...
    implicit open class MutableBuilder[Self <: PartialHTMLImageElement] (val x: Self) extends AnyVal {
      ...
      inline def setFetchPriority(value: String): Self = StObject.set(x, "fetchPriority", value.asInstanceOf[js.Any])
      ...
      inline def setHidePopover(value: () => Unit): Self = StObject.set(x, "hidePopover", js.Any.fromFunction0(value))
      
      inline def setHidePopoverUndefined: Self = StObject.set(x, "hidePopover", js.undefined)
      ...
      inline def setOnbeforetoggle(value: js.ThisFunction1[PartialHTMLImageElement, /* ev */ Event, Any]): Self = StObject.set(x, "onbeforetoggle", value.asInstanceOf[js.Any])
      
      inline def setOnbeforetoggleNull: Self = StObject.set(x, "onbeforetoggle", null)
      
      inline def setOnbeforetoggleUndefined: Self = StObject.set(x, "onbeforetoggle", js.undefined)
      ...
      inline def setOnscrollend(value: js.ThisFunction1[PartialHTMLImageElement, /* ev */ Event, Any]): Self = StObject.set(x, "onscrollend", value.asInstanceOf[js.Any])
      
      inline def setOnscrollendNull: Self = StObject.set(x, "onscrollend", null)
      ...
      inline def setPopoverNull: Self = StObject.set(x, "popover", null)
      ...
      inline def setShowPopover(value: () => Unit): Self = StObject.set(x, "showPopover", js.Any.fromFunction0(value))
      ...
      inline def setTogglePopover(value: () => Boolean): Self = StObject.set(x, "togglePopover", js.Any.fromFunction0(value))
      
      inline def setTogglePopoverUndefined: Self = StObject.set(x, "togglePopover", js.undefined)
