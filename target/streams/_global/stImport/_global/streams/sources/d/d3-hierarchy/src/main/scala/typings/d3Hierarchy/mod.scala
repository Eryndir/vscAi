...
object mod {
  ...
  trait HierarchyCircularNode[Datum]
    ...
    /**
      ...
      */
    @JSName("x")
    var x_HierarchyCircularNode: Double = js.native
    
    /**
      * The y-coordinate of the circle’s center.
      */
    @JSName("y")
    var y_HierarchyCircularNode: Double = js.native
  }
  ...
  trait HierarchyPointNode[Datum]
    ...
    /**
      ...
      */
    @JSName("x")
    var x_HierarchyPointNode: Double = js.native
    
    /**
      * The y-coordinate of the node.
      */
    @JSName("y")
    var y_HierarchyPointNode: Double = js.native
  }
