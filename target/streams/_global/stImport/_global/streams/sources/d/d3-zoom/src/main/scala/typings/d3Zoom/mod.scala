...
object mod {
  ...
  object D3ZoomEvent {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: D3ZoomEvent[?, ?], ZoomRefElement /* <: Element */, Datum] (val x: Self & (D3ZoomEvent[ZoomRefElement, Datum])) extends AnyVal {
  ...
  trait ZoomBehavior[ZoomRefElement /* <: Element */, Datum]
    ...
    /**
      ...
      */
    def interpolate[// eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    InterpolationFactory /* <: js.Function2[/* a */ ZoomView, /* b */ ZoomView, js.Function1[/* t */ Double, ZoomView]] */](): InterpolationFactory = js.native
