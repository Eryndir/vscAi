...
import typings.d3Array.mod.Matrix
import typings.d3Array.mod.NestedArray
import typings.d3Array.mod.NestedInternMap
...
object mod {
  ...
  inline def autoType[ParsedRow /* <: js.UndefOr[js.Object | Null] */, Columns /* <: String */](`object`: js.Array[String]): ParsedRow = ^.asInstanceOf[js.Dynamic].applyDynamic("autoType")(`object`.asInstanceOf[js.Any]).asInstanceOf[ParsedRow]
  inline def autoType[ParsedRow /* <: js.UndefOr[js.Object | Null] */, Columns /* <: String */](`object`: DSVRowString[Columns]): ParsedRow = ^.asInstanceOf[js.Dynamic].applyDynamic("autoType")(`object`.asInstanceOf[js.Any]).asInstanceOf[ParsedRow]
  ...
  inline def blur(data: ArrayLike[Double], radius: Double): ArrayLike[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("blur")(data.asInstanceOf[js.Any], radius.asInstanceOf[js.Any])).asInstanceOf[ArrayLike[Double]]
  
  inline def blur2(data: Matrix, rx: Double): Matrix = (^.asInstanceOf[js.Dynamic].applyDynamic("blur2")(data.asInstanceOf[js.Any], rx.asInstanceOf[js.Any])).asInstanceOf[Matrix]
  inline def blur2(data: Matrix, rx: Double, ry: Double): Matrix = (^.asInstanceOf[js.Dynamic].applyDynamic("blur2")(data.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any])).asInstanceOf[Matrix]
  
  inline def blurImage(imageData: ImageData, rx: Double): ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("blurImage")(imageData.asInstanceOf[js.Any], rx.asInstanceOf[js.Any])).asInstanceOf[ImageData]
  inline def blurImage(imageData: ImageData, rx: Double, ry: Double): ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("blurImage")(imageData.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any])).asInstanceOf[ImageData]
  ...
  inline def flatGroup[TObject, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): js.Array[
    /* import warning: importer.ImportType#apply c repeated non-array type: TKeys */ js.Array[TKeys]
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("flatGroup")(iterable.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Array[
    /* import warning: importer.ImportType#apply c repeated non-array type: TKeys */ js.Array[TKeys]
  ]]
  
  inline def flatRollup[TObject, TReduce, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    reduce: js.Function1[/* values */ js.Array[TObject], TReduce],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): js.Array[
    /* import warning: importer.ImportType#apply c repeated non-array type: TKeys */ js.Array[TKeys]
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("flatRollup")(iterable.asInstanceOf[js.Any], reduce.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Array[
    /* import warning: importer.ImportType#apply c repeated non-array type: TKeys */ js.Array[TKeys]
  ]]
  ...
  inline def forceSimulation_NodeDatumLinkDatum[NodeDatum /* <: SimulationNodeDatum */, // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  LinkDatum /* <: SimulationLinkDatum[NodeDatum] */](): Simulation[NodeDatum, LinkDatum] = ^.asInstanceOf[js.Dynamic].applyDynamic("forceSimulation")().asInstanceOf[Simulation[NodeDatum, LinkDatum]]
  inline def forceSimulation_NodeDatumLinkDatum[NodeDatum /* <: SimulationNodeDatum */, // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  LinkDatum /* <: SimulationLinkDatum[NodeDatum] */](nodesData: js.Array[NodeDatum]): Simulation[NodeDatum, LinkDatum] = ^.asInstanceOf[js.Dynamic].applyDynamic("forceSimulation")(nodesData.asInstanceOf[js.Any]).asInstanceOf[Simulation[NodeDatum, LinkDatum]]
  ...
  inline def group[TObject, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedInternMap[TObject, js.Array[TObject], TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("group")(iterable.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedInternMap[TObject, js.Array[TObject], TKeys]]
  ...
  inline def groups[TObject, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedArray[TObject, js.Array[TObject], TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("groups")(iterable.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedArray[TObject, js.Array[TObject], TKeys]]
  ...
  inline def index[TObject, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedInternMap[TObject, TObject, TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("index")(iterable.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedInternMap[TObject, TObject, TKeys]]
  
  inline def indexes[TObject, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedArray[TObject, TObject, TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("indexes")(iterable.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedArray[TObject, TObject, TKeys]]
  ...
  inline def medianIndex(iterable: js.Iterable[js.UndefOr[Numeric | Null]]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("medianIndex")(iterable.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def medianIndex[T](
    iterable: js.Iterable[T],
    accessor: js.Function3[/* element */ T, /* i */ Double, /* array */ js.Iterable[T], js.UndefOr[Double | Null]]
  ): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("medianIndex")(iterable.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def pathRound(): Path_ = ^.asInstanceOf[js.Dynamic].applyDynamic("pathRound")().asInstanceOf[Path_]
  inline def pathRound(digits: Double): Path_ = ^.asInstanceOf[js.Dynamic].applyDynamic("pathRound")(digits.asInstanceOf[js.Any]).asInstanceOf[Path_]
  ...
  inline def quantileIndex(iterable: js.Iterable[js.UndefOr[Numeric | Null]], p: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("quantileIndex")(iterable.asInstanceOf[js.Any], p.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def quantileIndex[T](
    iterable: js.Iterable[T],
    p: Double,
    accessor: js.Function3[/* element */ T, /* i */ Double, /* array */ js.Iterable[T], js.UndefOr[Double | Null]]
  ): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("quantileIndex")(iterable.asInstanceOf[js.Any], p.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def rollup[TObject, TReduce, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    reduce: js.Function1[/* values */ js.Array[TObject], TReduce],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedInternMap[TObject, TReduce, TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("rollup")(iterable.asInstanceOf[js.Any], reduce.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedInternMap[TObject, TReduce, TKeys]]
  
  inline def rollups[TObject, TReduce, TKeys /* <: js.Array[Any] */](
    iterable: js.Iterable[TObject],
    reduce: js.Function1[/* values */ js.Array[TObject], TReduce],
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param keys because its type {[ Index in keyof TKeys ]: (value : TObject, index : number, values : Array<TObject>): TKeys[Index]} is not an array type */ keys: /* import warning: importer.ImportType#apply Failed type conversion: {[ Index in keyof TKeys ]: (value : TObject, index : number, values : std.Array<TObject>): TKeys[Index]} */ js.Any
  ): NestedArray[TObject, TReduce, TKeys] = (^.asInstanceOf[js.Dynamic].applyDynamic("rollups")(iterable.asInstanceOf[js.Any], reduce.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[NestedArray[TObject, TReduce, TKeys]]
