...
object CSSKeyframeRule {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(CHARSET_RULE = 2, COUNTER_STYLE_RULE = 11, FONT_FACE_RULE = 5, FONT_FEATURE_VALUES_RULE = 14, IMPORT_RULE = 3, KEYFRAMES_RULE = 7, KEYFRAME_RULE = 8, MEDIA_RULE = 4, NAMESPACE_RULE = 10, PAGE_RULE = 6, STYLE_RULE = 1, SUPPORTS_RULE = 12, cssText = cssText.asInstanceOf[js.Any], keyText = keyText.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any], parentRule = null, parentStyleSheet = null)
